 ...
 <!-- สำนักตรวจสอบ -->
  <?php if(!empty($rs)){?>
        <div class='col-md-12'>
			<div class='row'>
				<div class='col-md-12'>
					<p><b><u>สรุป</u></b> จำนวนการขอใช้ระบบประชุมทางไกลองค์การสวนสัตว์(VDO Conference) ทั้งหมด <?php echo $counttotal;?> ครั้ง</p>
				</div>
				<div class='col-md-12 page' style="float:left;">
					<?php
					$columns = array('eventconfer_start','eventconfer_end','headncf_name','eventconfer_story','zoo_name');
					$grid = new gridView();
