...
@$yearthai  = $_POST['year'];    // แปลง ปีพ.ศ. เป็น ปีค.ศ.
  ...
  if($month){
    ...
    switch($conferrenname){
        case 1: $confertxt = "ห้องประชุมองค์การสวนสัตว์ 1"; break;
        case 2: $confertxt = "ห้องประชุมองค์การสวนสัตว์ 2"; break;
        case 3: $confertxt = "ห้องประชุมองค์การสวนสัตว์ 3"; break;
 ...
 <!-- สำนักตรวจสอบ -->
  <?php if(!empty($rs)){?>
        <div class='col-md-12'>
			<div class='row'>
				<div class='col-md-12'>
					<p><b><u>สรุป</u></b> จำนวนการขอใช้ห้องประชุมทั้งหมด <?php echo $counttotal;?> ครั้ง</p>
				...
				<div class='col-md-12 page' style="float:left;">
					...
					$grid->name = 'table1';
					$grid->width = array('10%','10%','20%','10%','25%');
