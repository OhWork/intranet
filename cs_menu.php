<nav class="navbar navbar-expand-lg navbar-light col-md-12" style="background-color:#d4edda;color:#155724;border:solid 1px #c3e6cb;">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
		<a class="navbar-brand">
			<img src="images/no_pic2.png" alt="">
		</a>
...
-->
		<a class="nav-item nav-link backhome" href="cs_index.php?url2=cs_show_problem.php&subpage=1">รายการแจ้งซ่อม</a>
		<a class="nav-item nav-link" href="http://192.168.0.1"><img src="images/icons/home.png" /></a>
    </div>
  </div>
</nav>
