...
<?php
	...
	$buttonprintpdf = new buttonok('ค้นหา','','btn btn-default trspdf','submit');
     ...
     ?>
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-3" style="background-color:#ffffff;" id="maincontent">
	<div class='row'>
...
<?php echo $form->close();
    ...
    if($date){
        ...
        $qua = "touristreport_date BETWEEN '$yearthaifirst-10-01' AND  '$yearthaichange-09-30' AND ";
    }else{
        $date = date("Y-m-d");
        $qua = "touristreport_date BETWEEN '$date' AND  '$date' AND ";
    }
